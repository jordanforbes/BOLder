...
def gui(browse_input_file, browse_output_folder, convert):
  ...
  browse_input_button = tk.Button(root, text="Select EPUB File", command=lambda: browse_input_file(entry_input_path))
  ...
  browse_output_button = tk.Button(root, text = "Select Output Folder", command=lambda: browse_output_folder(entry_output_folder))
